import mirakl from "../images/mirakl.png";
              ...
              <div className="relative px-4 sm:px-8 lg:px-12">
                <div className="mx-auto max-w-2xl lg:max-w-5xl">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-6 flex items-center text-base text-zinc-600">
                      Junior Software Engineer at
                      <a href="https://www.welcometothejungle.com/companies/mirakl">
                        <img alt="Mirakl" className="h-14" src={mirakl} />
                      </a>
                    </p>
                    <div className="mt-6 flex gap-6">
                      <a
                        ...
                        href="https://github.com/bastiensun"
                      >
                        <svg
                          aria-hidden="true"
                      ...
                      <a
                        ...
                        className="group -m-1 p-1"
                        href="https://linkedin.com/in/bastien-sun"
                      >
                        <svg
                          aria-hidden="true"
                          className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 "
